		...
		public class ViewModel : BaseViewModel
		{
			...
			public ICommand RegisterCommand => new Command(async () => {
				...
				try
				{
					...
					response = await WebClient.Instance.SendAsync(HttpMethod.Post, new Uri(Settings.REGISTER_URL), content, 45, cancelTokenSource.Token);
				}
            ...
            public ICommand LoginCommand => new Command(async () => await App.GlobalPage.PushRoot(new Pages.Auth.Login()));
